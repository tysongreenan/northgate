...
3. You should see a slim near-black **Northgate** banner at the top immediately (even on a guest page, before anyone types). First paint says **Northgate · script loaded**, then it upgrades when the adapter starts.
